  ...
  return (
    <div>
      ...
      <div className="w-screen h-screen grid-cols-12 grid-rows-12 grid">
        <div className="z-0 m-6 text-8xl sm:row-start-1 sm:text-left inter-extralight text-center col-start-1 row-start-1 row-span-full col-span-full">
          About Us
        </div>
      ...
      <div className='m-6 pr-10 grid grid-cols-12 grid-rows-12 w-screen h-screen'>
        ...
        <div className='invisible md:visible col-start-1 row-start-2 mt-16 col-span-8 row-span-8 grid grid-cols-2 grid-rows-2 gap-1 w-fit h-fit'>
