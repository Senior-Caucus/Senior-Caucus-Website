  ...
  return (
    <div>
      ...
      <div className="w-screen h-screen grid-cols-12 grid-rows-12 grid">
        <div className="z-0 m-6 text-8xl inter-extralight col-start-1 row-start-1 col-span-full">
          About Us
        </div>
        <Image className="z-1 row-start-3 row-span-5 col-start-1 ml-20 col-span-6 " src={RecDefault} alt="About us image" />
        <div className="z-0 row-start-8 col-start-5 row-span-4 col-span-7 text-2xl inter-extralight">
