    ...
    return (
        <div className={`${props.className}`}>
            <div className="grid grid-cols-12 grid-rows-12">
                <Image className="rounded-md col-start-2 col-span-4 row-start-1 row-span-full w-fill h-fill" src={props.image} alt={`Image for ${props.name}, who is ${props.position}`} />
                <div className="ml-2 col-start-6 col-span-6 row-start-1 row-span-full">
                    ...
                    <div className="inter-extralight">
                        {props.description}
                    </div>
                </div>
            </div>
